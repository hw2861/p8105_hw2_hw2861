...
I chose to keep the row to 534. 
This is because row 535 is the summary note "Grand total".
```{r Trash_wheel}
...
The total number of sports balls collected by Mr. Trash Wheel in 2020 was **`r sum(Trash_wheel$sports_balls[which(Trash_wheel$year == 2020)])`**  .
